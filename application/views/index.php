	 	...
	 	<header id="header">
	 		<div class="container">
	 			<div class="logo float-left">
	 				<a href="index.html"><img src="<?php echo base_url("assets/images/ambulance.jpg");?>" alt="" class="img-responsive img-fluid"></a>
	 			</div>
	 					...
	 					<div class="col-lg-12 col-md-12">
	 						<div class="content">
								<form class="row" action="<?php echo base_url('search');?>" method="POST">
									<input type="text" placeholder="Enter certificate no." name="searchQuery" class="form-control w-100" />
